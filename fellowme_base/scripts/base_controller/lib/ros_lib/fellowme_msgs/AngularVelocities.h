#ifndef _ROS_fellowme_msgs_AngularVelocities_h
#define _ROS_fellowme_msgs_AngularVelocities_h
...
namespace fellowme_msgs
{
  ...
  class AngularVelocities : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "fellowme_msgs/AngularVelocities"; };
