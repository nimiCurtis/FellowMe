...
fellowme::Encoder::Encoder(ros::NodeHandle& nh, uint8_t pin1, uint8_t pin2, int encoder_resolution)
  : nh_(nh)
  , encoder(pin1, pin2)
...
fellowme::JointState fellowme::Encoder::jointState()
{
...
double fellowme::Encoder::angularPosition()
{
    return joint_state_.angular_position_;
}


double fellowme::Encoder::angularVelocity()
{
    return joint_state_.angular_velocity_;
}

double fellowme::Encoder::ticksToAngle(const int &ticks) const
{
