...
#ifndef FELLOWME_ENCODER_H
#define FELLOWME_ENCODER_H
...
namespace fellowme
{
    ...
    /** \brief Decorates the Arduino Encoder Library to read the angular wheel velocity
     * from quadrature wheel encoders.
     * 
     * This class is composed of \ref ::Encoder from https://www.pjrc.com/Arduino/td_libs_Encoder.html,
    ...
    {
    public:
        // Arduino Encoder class that is capable of reading rising and falling edges of two Hall effect signals.
        ::Encoder encoder;

        /** \brief Construct a fellowme::Encoder providing access to quadrature encoder ticks and angular joint velocity.
         * 
