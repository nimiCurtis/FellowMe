...
namespace fellowme {
    ...
    private:
        ...
        fellowme::Encoder encoder_left_;
        fellowme::Encoder encoder_right_;
        long ticks_left_ = 0, ticks_right_ = 0;

        // Measured left and right joint states (angular position (rad) and angular velocity (rad/s))
        fellowme::JointState joint_state_left_, joint_state_right_;
        ...
        ros::Subscriber<fellowme_msgs::WheelsCmdStamped, BaseController<TMotorController, TMotorDriver>> sub_wheel_cmd_velocities_;
        ...
        ros::Subscriber<fellowme_msgs::PIDStamped, BaseController<TMotorController, TMotorDriver>> sub_pid_left_;
        ros::Subscriber<fellowme_msgs::PIDStamped, BaseController<TMotorController, TMotorDriver>> sub_pid_right_;
        PID motor_pid_left_;
...
template <typename TMotorController, typename TMotorDriver>
using BC = fellowme::BaseController<TMotorController, TMotorDriver>;


template <typename TMotorController, typename TMotorDriver>
fellowme::BaseController<TMotorController, TMotorDriver>
    ::BaseController(ros::NodeHandle &nh, TMotorController* motor_controller_left, TMotorController* motor_controller_right)
    : nh_(nh)
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::setup()
{
    nh_.initNode();
...
{   
    ...
    log_msg = String("/fellowme/mobile_base_controller/wheel_radius: ") + String(wheel_radius_);
    nh_.loginfo(log_msg.c_str());
    nh_.getParam("/fellowme/mobile_base_controller/linear/x/max_velocity", &max_linear_velocity_);
    log_msg = String("/fellowme/mobile_base_controller/linear/x/max_velocity: ") + String(max_linear_velocity_);
    nh_.loginfo(log_msg.c_str());
    nh_.getParam("/fellowme/debug/base_controller", &debug_);
    log_msg = String("/fellowme/debug/base_controller: ") + String(debug_);
    nh_.loginfo(log_msg.c_str());

    nh_.loginfo("Initialize fellowme Wheel Encoders");
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::commandCallback(const fellowme_msgs::WheelsCmdStamped& cmd_msg)
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::resetEncodersCallback(const std_msgs::Empty& reset_msg)
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::pidLeftCallback(const fellowme_msgs::PIDStamped& pid_msg)
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::pidRightCallback(const fellowme_msgs::PIDStamped& pid_msg)
{
    // Callback function to update the pid values of the left motor
    // This callback function receives fellowme_msgs::PID message object
    // where fellowme_msgs::PID kp, ki, kd for one pid controller is stored
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::read()
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::write()
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::eStop()
{
...
template <typename TMotorController, typename TMotorDriver>
void fellowme::BaseController<TMotorController, TMotorDriver>::printDebug()
{
    /*
    String log_msg =
            String("\nRead:\n") +
