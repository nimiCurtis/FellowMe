#ifndef _ROS_fellowme_msgs_WheelsCmdStamped_h
#define _ROS_fellowme_msgs_WheelsCmdStamped_h
...
#include "fellowme_msgs/WheelsCmd.h"
...
namespace fellowme_msgs
{
  ...
  class WheelsCmdStamped : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef fellowme_msgs::WheelsCmd _wheels_cmd_type;
    ...
    virtual const char * getType() override { return "fellowme_msgs/WheelsCmdStamped"; };
