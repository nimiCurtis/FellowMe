#ifndef _ROS_fellowme_msgs_PIDStamped_h
#define _ROS_fellowme_msgs_PIDStamped_h
...
namespace fellowme_msgs
{
  ...
  class PIDStamped : public ros::Msg
  {
    public:
      ...
      _header_type header;
      typedef fellowme_msgs::PID _pid_type;
      _pid_type pid;
    ...
    virtual const char * getType() override { return "fellowme_msgs/PIDStamped"; };
