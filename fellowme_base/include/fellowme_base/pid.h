...
namespace fellowme_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(fellowme_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(fellowme_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<fellowme_base::ParametersConfig> DynamicReconfigServer;
