#ifndef FELLOWME_HW_INTERFACE_H
#define FELLOWME_HW_INTERFACE_H
...
#include <fellowme_msgs/AngularVelocitiesStamped.h>
...
namespace fellowme_base
{
    ...
    class FellowmeHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        FellowmeHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~FellowmeHWInterface() {}
    ...
    protected:
        ...
        void encoderTicksCallback(const fellowme_msgs::EncodersStamped::ConstPtr& msg_encoders);
        ...
        // fellowme directly calculates normalized angles from encoder ticks
        ...
        /** \brief fellowme reports travel distance in metres, need radians for ros_control RobotHW */
        double linearToAngular(const double &distance) const;
        /** \brief RobotHW provides velocity command in rad/s, fellowme needs m/s. */
        ...
        // The parameters are defined in fellowme_base/config/base.yaml
        ...
        // This subscriber receives the encoder ticks in the custom fellowme_msgs/Encoder message
        ...
        // This subscriber receives the measured angular wheel joint velocity in the custom fellowme_msgs/AngularVelocitiesStamped message
    ...
    };  // class fellowmeHWInterface

}  // namespace

#endif // fellowme_HW_INTERFACE_H